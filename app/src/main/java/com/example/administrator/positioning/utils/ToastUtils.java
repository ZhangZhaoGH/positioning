package com.example.administrator.positioning.utils;
...
import com.example.administrator.positioning.MyApplication;
...
public class ToastUtils {
   ...
   public static void showToast(String text){
	...
	private static void showSnackMessage(View v, String msg, Snackbar.Callback callback,
		...
		snack.getView().setBackgroundColor(MyApplication.getContext().getResources().getColor(R.color.title_bg));
