package com.example.administrator.positioning.ui.view;
...
import com.example.administrator.positioning.utils.AMapUtil;

import java.util.ArrayList;
import java.util.List;

/**
 * Created by Sherlock on 2017/1/11.
 * 自定义班车路线规划类
 */
...
public class MyRouteOverlay extends RouteOverlay {
    ...
    private List<ClassCarSiteBean> routeList;
     ...
     */
    public MyRouteOverlay(Context context, AMap amap, DrivePath path,
    ...
    protected void addStartAndEndMarker() {
        startMarker = mAMap.addMarker((new MarkerOptions())
                ...
                .title(routeList.get(0).getSitename()));
        // startMarker.showInfoWindow();

        endMarker = mAMap.addMarker((new MarkerOptions()).position(endPoint)
                .icon(getEndBitmapDescriptor()).title(routeList.get(routeList.size() - 1).getSitename()));
    ...
    public void showMarker(int index) {
        if (index != -1) {
            if (index == 0) {
                ...
                throughPointMarkerList.get(index - 1).showInfoWindow();
            }
        }
    }
    ...
    protected int getDriveColor() {
        return Color.parseColor("#4474e5");
    }
                ...
                if (latLonPoint != null) {
                    throughPointMarkerList.add(mAMap
                            .addMarker((new MarkerOptions())
                                    ...
                                    .title(routeList.get(i + 1).getSitename())));
                }
            }
        }
    }
    ...
    private BitmapDescriptor getThroughPointBitDes() {
        return BitmapDescriptorFactory.fromResource(R.mipmap.bus_route_station_image);
    ...
    public void setRouteList(List<ClassCarSiteBean> routeList) {
